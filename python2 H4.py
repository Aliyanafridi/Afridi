...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕H4 A4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕H4 A4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : H4_HAMID_A4_MASTER
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update H4_HAMID Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' H4_HAMID WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To H4_HAMID')
	    psb('Congratulations H4_HAMID Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel H4 HAMID A4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/H4_HAMID && python2 H4.py')
	elif bm =='3':
